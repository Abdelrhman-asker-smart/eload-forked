        ...
        <div className="row my-4">
          ...
          <label className="my-2 d-block">Beneficiary Bank</label>
            {
              banksOptions.length > 0 && 
                ...
                defaultValue={banksOptions.find(({ value }) => value === account.bank_code)}
          ...
          <div className="col-md-4">
            ...
            <input
              ...
              onChange={(e) => setAccount({...account, bank_address: e.target.value})}
            />
          </div>
          <div className="col-md-4">
          ...
          <label className="my-2 d-block">Beneficiary Currency</label>
            {
              currenciesOptions.length > 0 && 
                ...
                defaultValue={currenciesOptions.find(({ value }) => value === account.currency)}
                onChange={(choice) => setAccount({...account, currency: choice.value})}
              />
            }
          </div>
        </div>
