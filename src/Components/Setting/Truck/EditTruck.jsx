    ...
    <div className='container-fluid input-section'>
        <div className='row'>
          <div className='col-md-12'>
              <label className='mx-3 my-3' for="truckname">Name</label>
              <input className='nameinput' type="text" placeholder='name' name='truckname'/>
          </div>
            <div className='col-md-4 my-4'>
                <label for="truckimg" className='mx-3 my-3'>Add photo</label>
                <input className='truckimg' type="file" id="truckimg" name="truckimg" accept="image/png, image/jpeg"/>
            </div>
        </div>

      <div className='btn-side text-center my-5'>
          <button className='btn save-btn' data-bs-toggle="modal" href="#exampleModalToggle">Save</button>
      </div>
