        ...
        <div className='input-shipper '>
          ...
          <select class="form-select custom-select" aria-label="Default select example" >
            ...
            <option value="3" className='text-center py-3'>
              <div className='text-center py-3' style={{color:"red", background:"black"}}>Add</div>
            </option>
          </select>
        </div>
      </div>
      <div className='pick-up box-inputs'>
        ...
        <div className='inputs row'>
          ...
          <div className='input col-md-4'>
            ...
            <DatePicker className='date-input position-relative px-5'
            selected={startDate}
            onChange={(date) => setStartDate(date)}
            dateFormat="MMMM d, yyyy"
          />
          <Dateicon className='position-absolute top-2 left-2' style={{marginTop:"3%", marginLeft:"2%"}}/>
          ...
          <button><i class="fa-solid fa-plus me-3"></i> Add New Address</button>
          </NavLink>
