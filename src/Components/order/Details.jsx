    ...
    () => [
        ...
        Cell: ({ renderedCellValue, row }) => (
          ...
          >
            ...
            (row.original.status == "PENDING" ||
              row.original.status == "MODIFICATION-REQUEST") ? (
              <>
                <span
      ...
      },
      {
        accessorFn: (row) => {
          ...
          return `${
            row.status == "MODIFICATION-REQUEST" ? row.modification_reason : ""
          }`;
        },
              ...
              (row.original.status == "PENDING" ||
                ...
                <>
                  <button
                    ...
                    onClick={() => {
                      changeCost(row.original.id, row.original.shippingcost);
                    }}
                  >
                    Change Cost
                  </button>
            ...
            {user_type == "shipper" && row.original.status == "REVIEWED" && (
              <>
                <button
                  ...
                  onClick={() => {
                    sendModificationRequest(row.original.id, "CHANGE-COST");
                  }}
                >
                  Change Cost
                </button>
                ...
                <button
                  ...
                  onClick={() => {
                    sendModificationRequest(
                      row.original.id,
                      "OTHER",
                      row.original.modification_reason
                    );
                  }}
                >
                  Other
              ...
              <div className="col-md-12 text-center">
                <div>
                  ...
                  <Select
                    ...
                    onChange={(choice) =>
                      setSelectedPaymentMethod(choice.value)
                    }
                  />
                </div>
