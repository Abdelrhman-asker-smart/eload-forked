  ...
  const showNotification = (e, notification) => {
    ...
    let Msg = ({ closeToast, toastProps }) => (
      <div>
            ...
            <div className="row py-3 px-2">
              ...
              <div className="col-md-4 d-flex align-items-center my-2">
                <label className="mx-2">
                  {notification.payload.from_city_name}
                </label>
              </div>
              <div className="col-md-8 d-flex align-items-center my-2">
                <svg
              ...
              <div className="col-md-4 d-flex align-items-center my-2">
                <label className="mx-2">
                  {notification.payload.to_city_name}
                </label>
              </div>
              ...
              <div className="col-md-5 d-flex align-items-center my-2">
                <label className="mx-2">
                  {notification.payload.pickup_date}
                </label>
              </div>
              <div className="col-md-8 d-flex align-items-center my-2">
                <svg
              ...
              <div className="col-md-4 d-flex align-items-center my-2">
                <label className="mx-2">
                  {notification.payload.shipment_type_name}
                </label>
              </div>
              <div className="col-md-8 d-flex align-items-center my-2">
                <svg
              ...
              <div className="col-md-4 d-flex align-items-center my-2">
                <label className="mx-2">
                  {notification.payload.truck_type_name}
                </label>
              </div>

              {notification.payload.provider_price &&
                (user_type === "admin" || user_type === "provider") && (
                  <>
                    <div className="col-md-8 d-flex align-items-center my-2">
                      <svg
                        className="mx-2"
        ...
        <a
          href={`/${entity_mappings[notification.notificationable_type].url}/${
        ...
        {notification.payload.status === "READY" &&
          user_type === "provider" && (
            <button
              ...
              onClick={(e) => sendInterest(e, notification.payload.id)}
            >
              I'm Interested!
            </button>
          )}
