...
const Sidebar = () => {
  ...
  const openBtn1 = () => {
    setIsOpen({
      firstLevel1: !isOpen.firstLevel1,
      firstLevel2: false,
      firstLevel3: false,
      firstLevel4: false,
      firstLevel5: false,
  ...
  const openBtn2 = () => {
    setIsOpen({
      firstLevel1: false,
      firstLevel2: !isOpen.firstLevel2,
      firstLevel3: false,
      firstLevel4: false,
      firstLevel5: false,
      firstLevel6: false,
  ...
  const openBtn3 = () => {
    setIsOpen({
      firstLevel1: false,
      firstLevel2: true,
      firstLevel3: !isOpen.firstLevel3,
      firstLevel4: false,
      firstLevel5: false,
      firstLevel6: false,
      firstLevel7: false,
  ...
  const openBtn4 = () => {
    setIsOpen({
      ...
      firstLevel2: true,
      firstLevel3: false,
      firstLevel4: !isOpen.firstLevel4,
      firstLevel5: false,
      firstLevel6: false,
      firstLevel7: false,
      firstLevel8: false,
  ...
  const openBtn5 = () => {
    setIsOpen({
      ...
      firstLevel3: false,
      firstLevel4: false,
      firstLevel5: !isOpen.firstLevel5,
      firstLevel6: false,
      firstLevel7: false,
      firstLevel8: false,
      firstLevel9: false,
  ...
  const openBtn11 = () => {
    setIsOpen({
      ...
      firstLevel9: false,
      firstLevel10: true,
      firstLevel11: !isOpen.firstLevel11,
      firstLevel12: false,
      firstLevel13: false,
      firstLevel14: false,
      firstLevel15: false,
  ...
  const openBtn12 = () => {
    setIsOpen({
      ...
      firstLevel10: true,
      firstLevel11: false,
      firstLevel12: !isOpen.firstLevel12,
      firstLevel13: false,
      firstLevel14: false,
      firstLevel15: false,
      firstLevel16: false,
  ...
  const openBtn13 = () => {
    setIsOpen({
      ...
      firstLevel11: false,
      firstLevel12: false,
      firstLevel13: !isOpen.firstLevel13,
      firstLevel14: false,
      firstLevel15: false,
      firstLevel16: false,
      firstLevel17: false,
  ...
  const openBtn14 = () => {
    setIsOpen({
      ...
      firstLevel12: false,
      firstLevel13: false,
      firstLevel14: !isOpen.firstLevel14,
      firstLevel15: false,
      firstLevel16: false,
      firstLevel17: false,
      firstLevel18: false,
  ...
  const openBtn15 = () => {
    setIsOpen({
      ...
      firstLevel13: false,
      firstLevel14: false,
      firstLevel15: !isOpen.firstLevel15,
      firstLevel16: false,
      firstLevel17: false,
      firstLevel18: false,
      firstLevel19: false,
  ...
  const openBtn16 = () => {
    setIsOpen({
      ...
      firstLevel14: false,
      firstLevel15: false,
      firstLevel16: !isOpen.firstLevel16,
      firstLevel17: false,
      firstLevel18: false,
      firstLevel19: false,
    });
  ...
  const openBtn17 = () => {
    setIsOpen({
      ...
      firstLevel15: false,
      firstLevel16: false,
      firstLevel17: !isOpen.firstLevel17,
      firstLevel18: false,
      firstLevel19: false,
    });
  };
  ...
  const openBtn18 = () => {
    setIsOpen({
      ...
      firstLevel16: false,
      firstLevel17: false,
      firstLevel18: !isOpen.firstLevel18,
      firstLevel19: false,
    });
  };
  // admin-user-1
  const openBtn19 = () => {
    setIsOpen({
      ...
      firstLevel17: false,
      firstLevel18: false,
      firstLevel19: !isOpen.firstLevel19,
    });
  };
                ...
                <div className="acc-sidebar">
                  <Accordion>
                    ...
                    <AccordionItem>
                      <AccordionHeader
                        className={
                          isOpen.firstLevel1 ? "activeside d-flex" : " d-flex"
                        }
                        onClick={openBtn1}
                      >
                        <Shippments
                          className={
                            isOpen.firstLevel1 ? "svgicon mx-2" : " mx-2"
                          }
                        />
                        ...
                        <Arrow
                          className={
                            isOpen.firstLevel1 ? "downarrow" : " rightarrow"
                          }
                        />
                      </AccordionHeader>
                    ...
                    <AccordionItem>
                      <AccordionHeader
                        className={
                          isOpen.firstLevel2 ? "activeside d-flex" : " d-flex"
                        }
                        onClick={openBtn2}
                      >
                        <Serviceprovediers
                          className={
                            isOpen.firstLevel2 ? "svgicon mx-2" : " mx-2"
                          }
                        />

                        <h3 className={`accordion-title mt-1`}>
                          Service providers
                        </h3>
                        <Arrow
                          className={
                            isOpen.firstLevel2 ? "downarrow" : "rightarrow"
                          }
                        />
                      </AccordionHeader>
                        ...
                        <div className="accordion-body">
                          ...
                          <AccordionItem>
                            <AccordionHeader
                              className={
                                isOpen.firstLevel3
                                  ? "activeside d-flex bg-inside"
                                  : " d-flex bg-inside"
                              }
                              onClick={openBtn3}
                            >
                              <Freelancer
                                className={isOpen.firstLevel3 ? "svgicon" : ""}
                              />

                              <h4 className={`accordion-title mt-1`}>
                                Freelance drivers
                              </h4>
                              <Arrow
                                className={
                          ...
                          <AccordionItem>
                            ...
                            >
                              <Partners
                                className={isOpen.firstLevel4 ? "svgicon" : ""}
                              />
                    ...
                    <AccordionItem>
                      <AccordionHeader
                        className={
                          isOpen.firstLevel5 ? "activeside d-flex" : " d-flex"
                        }
                        onClick={openBtn5}
                      >
                        <Shippers
                          className={
                            isOpen.firstLevel5 ? "svgicon mx-2" : " mx-2"
                          }
                        />
                        ...
                        <Arrow
                          className={
                            isOpen.firstLevel5 ? "downarrow" : "rightarrow"
                          }
                        />
                      </AccordionHeader>
                    ...
                    {user_Id === "1" ? (
                      <AccordionItem>
                        ...
                        >
                          <Serviceprovediers
                            className={
                              isOpen.firstLevel9 ? "svgicon mx-2" : " mx-2"
                            }
                          />

                          <h3 className={`accordion-title mt-1`}>Admins</h3>
                          <Arrow
                            className={
                              isOpen.firstLevel9 ? "downarrow" : " rightarrow"
                            }
                          />
                        </AccordionHeader>
                        ...
                        <AccordionBody className="bg-inside">
                          <div className="accordion-body">
                            <NavLink
                              ...
                              to="/all-admins"
                            >
                              <Serviceprovediers className=" mx-2" />
                              {/* <svg
                                className="mx-2"
                                width="27"
                                height="22"
                ...
                <div className="acc-sidebar">
                  <Accordion>
                    <AccordionItem>
                      <AccordionHeader
                        className={
                          isOpen.firstLevel10 ? "activeside d-flex" : " d-flex"
                        }
                        onClick={openBtn10}
                      >
                        <Settings
                          className={
                            isOpen.firstLevel10 ? "svgicon mx-2" : " mx-2"
                          }
                        />
                        ...
                        <Arrow
                          className={
                            isOpen.firstLevel10 ? "downarrow" : "rightarrow"
                          }
                        />
                      </AccordionHeader>
                      ...
                      <AccordionBody className="bg-inside">
                        <div className="accordion-body">
                          ...
                          <AccordionItem>
                            ...
                            >
                              <Catigorybox
                                className={isOpen.firstLevel11 ? "svgicon" : ""}
                              />
                          ...
                          <AccordionItem>
                            ...
                            >
                              <Catigorybox
                                className={isOpen.firstLevel12 ? "svgicon" : ""}
                              />
                          ...
                          <AccordionItem>
                            ...
                            >
                              <Catigorybox
                                className={isOpen.firstLevel13 ? "svgicon" : ""}
                              />
                          ...
                          <AccordionItem>
                            ...
                            >
                              <Catigorybox
                                className={isOpen.firstLevel14 ? "svgicon" : ""}
                              />
                          ...
                          <AccordionItem>
                            ...
                            >
                              <Catigorybox
                                className={isOpen.firstLevel15 ? "svgicon" : ""}
                              />
                          ...
                          <AccordionItem>
                            ...
                            >
                              <Catigorybox
                                className={isOpen.firstLevel16 ? "svgicon" : ""}
                              />
                          ...
                          <AccordionItem>
                            ...
                            >
                              <Catigorybox
                                className={isOpen.firstLevel17 ? "svgicon" : ""}
                              />
                          ...
                          <AccordionItem>
                            ...
                            >
                              <Catigorybox
                                className={isOpen.firstLevel18 ? "svgicon" : ""}
                              />
                ...
                <div className="acc-sidebar">
                  <Accordion>
                    ...
                    <AccordionItem>
                      <AccordionHeader
                        className={
                          isOpen.firstLevel3 ? "activeside d-flex" : " d-flex"
                        }
                        onClick={openBtn3}
                      >
                        <Shippers
                          className={
                            isOpen.firstLevel3 ? "svgicon mx-2" : " mx-2"
                          }
                        />
                        ...
                        <Arrow
                          className={
                            isOpen.firstLevel3 ? "downarrow" : "rightarrow"
                          }
                        />
                      </AccordionHeader>
