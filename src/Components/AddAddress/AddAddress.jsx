      ...
      <div className="container-fluid p-5 addaddressstyel">
            ...
            <div className="input-choose-group">
              <div className="row">
                <div className="input-select col-6">
                  ...
                  <select class="form-select input" aria-label="Default select example" placeholder='Select a group'>
        ...
        <div className="form-address">
          ...
          <div className="address-input w-100 mb-5">
            ...
            <input type="text" className='input' placeholder='Type' /> {/* select */}
          </div>
          <div className="address-input w-100 mb-5">
            <p className='head-text mb-2'>City</p>
            <input type="text" className='input' placeholder='City' /> {/* select */}
          </div>
          <div className="address-input w-100 mb-5">
            <div className="row">
              ...
              <div className="input-add col-3 text-center"><i class="fa-solid fa-plus"></i></div>
            </div>
          </div>
          <div className="address-input w-100 mb-5">
            <p className='head-text mb-2'>Address</p>
            <input type="text" className='input input-text-area' placeholder='Address' />
          </div>
        </div>
