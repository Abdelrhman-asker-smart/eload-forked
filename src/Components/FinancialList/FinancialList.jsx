            ...
            <div className="container-fluid financiallist px-4">
                ...
                <div className="request-nav">
                    <div className="row">
                        ...
                        <div className="col-2">
                            <input type="text" className="text-input input" placeholder="Shipment Number"/>
                        </div>
                        <div className="col-2">
                        <select class="form-select input" aria-label="Default select example">
                        ...
                        <div className="col-1">
                        <input type="text" className="text-input input" placeholder="Total"/>
                        </div>
                        <div className="col-1">
                        <select class="form-select input" aria-label="Default select example">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><button className='table-btn-red me-2'>Pending</button></td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td>Desposits</td>
                                <td>100 SAR</td>
                                <td>sfdghfyhglkjhgfdsyzfgjsfhdjjlihguyfutd</td>
                                <td><button className='table-btn-green me-2'>Done</button></td>
                            </tr>
                            <tr>
                                <td>3</td>
                                <td>Desposits</td>
                                <td>100 SAR</td>
                                <td>sfdghfyhglkjhgfdsyzfgjsfhdjjlihguyfutd</td>
                                <td><button className='table-btn-blue me-2'>In progress</button></td>
                            </tr>
                            <tr>
                                <td>4</td>
                                <td>Desposits</td>
