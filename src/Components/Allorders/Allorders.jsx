                        ...
                        <div className='orders-box my-2'>
                            ...
                            <div className='data-info row py-3 mx-3'>
                                <div className='col-md-3 col-data py-2'>
                                    ...
                                    <div className='px-3'>
                                        <span className='addres-span' >Sharafiyah Dist,Jeddah</span><br />
                                        <span className='text-info'>FaisalAbdullah</span><br />
                                ...
                                <div className='col-md-3 col-data py-2 col2-data'>
                                    ...
                                    <div className='px-3'>
                                        <span className='addres-span' >Al Ta'aown Dist,Mecca</span><br />
                                        <span className='text-info'>FaisalAbdullah</span><br />
                                        <span className='text-info'>+92 335 2522522</span>
                                    </div>
                                </div>
                                <div className='col-md-2 col-data col2-data'>
                                    ...
                                    <div className='title d-flex align-items-center'>
                                        <svg className='mx-2' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <path d="M9.93014 2.48004L4.59014 5.44004C3.38014 6.11004 2.39014 7.79004 2.39014 9.17004V14.82C2.39014 16.2 3.38014 17.88 4.59014 18.55L9.93014 21.52C11.0701 22.15 12.9401 22.15 14.0801 21.52L19.4201 18.55C20.6301 17.88 21.6201 16.2 21.6201 14.82V9.17004C21.6201 7.79004 20.6301 6.11004 19.4201 5.44004L14.0801 2.47004C12.9301 1.84004 11.0701 1.84004 9.93014 2.48004Z" stroke="#B2B2B2" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                ...
                                <div className='col-md-2 col-data'>
                                    ...
                                    <div className='box mb-3'>
                                        <div className='title d-flex align-items-center'>
                                            <svg className='mx-2' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M17.25 8.29004C14.26 5.63004 9.74 5.63004 6.75 8.29004L8.93 11.79C10.68 10.23 13.32 10.23 15.07 11.79L17.25 8.29004Z" stroke="#B2B2B2" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                            </svg>
                                            <p>WEIGHT</p>
                                        </div>
                                        <div className='px-3'>
                                    ...
                                    <div className='title d-flex align-items-center'>
                                        <svg className='mx-2' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <path d="M4.77979 8.30005V12.7001" stroke="#A9A9A9" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                    ...
                                    <div className='box mb-3'>
                                        <div className='title d-flex align-items-center'>
                                            <svg className='mx-2' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M3.5 9.08997H20.5" stroke="#A9A9A9" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
