    ...
    <div className='container profile p-5'>
        <div className='row'>
            ...
            <div className='col-md-6 text-center py-4'>
                ...
                <button className='btn btn-profile'>Edit</button>
                </NavLink>
            </div>
        </div>
        <div className='row info py-5 px-4 '>
            <div className='col-md-6'>
                <div className='info-line d-flex justify-content-between py-3'>
                    <h5>Name</h5>
                    <h5>Mohmoud Ahmed</h5>
                </div>
        ...
        <div className='password-side'>
            <h5 className='my-4'>Change Passoword</h5>
            <div className='row'>
                <div className='col-md-4'>
                    <label className='d-block my-3'>Old Password</label>
                    <input type="password" className='pass-input px-3 py-2' placeholder='******'/>
                </div>
                <div className='col-md-4'>
                    <label className='d-block my-3'>New Password</label>
                    <input type="password" className='pass-input px-3 py-2' placeholder='******' />
                </div>
                <div className='col-md-4'>
                    <label className='d-block my-3'>Confirm Password</label>
                    <input type="password" className='pass-input px-3 py-2' placeholder='******'/>
                </div>
            </div>
        </div>
        <button className='btn btn-profile align-items-center my-5'
            data-bs-toggle="modal"
            href="#exampleModalToggle"
        style={{marginLeft:"40%"}}>Save</button>
