                    ...
                    <div className="row">
                        ...
                        <div className="shipments-data col-3 card-header py-4">
                            <div className="card-box">
                                ...
                                <div className="data-card">
                                    <a href="#" className='btn-data-card'>View All</a>
                                </div>    
                            </div>
                        </div>
                    </div>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input me-3" id="customCheck1" />
                                <label class="custom-control-label" for="customCheck1">1</label>
                            </div>
                            </td>
                            <td>ELD00028</td>
                            <td>Jeddah  <span className='ms-3'><i class="fa-solid fa-arrow-right"></i></span></td>
                            <td>Mecca</td>
                            <td>Dry 40 high cube</td>
                            <td>Flatbed</td>
                            <td>SAR17,756.000</td>
                            <td>2022-09-14</td>
                            <td><span className='btn-blur-table btn-table'>New</span></td>
                        </tr>
                        <tr>
                            <td>
                            <div class="custom-control custom-checkbox">
                        ...
                        <tr>
                            ...
                            <td>SAR17,756.000</td>
                            <td>2022-09-14</td>
                            <td><span className='btn-red-table btn-table'>Assigned</span></td>
                        </tr>
                        <tr>
                            <td>
                            <div class="custom-control custom-checkbox">
                        ...
                        <tr>
                            ...
                            <td>SAR17,756.000</td>
                            <td>2022-09-14</td>
                            <td><span className='btn-blue-light-table btn-table'>On the Way </span></td>
                        </tr>
                        <tr>
                            <td>
                            <div class="custom-control custom-checkbox">
                        ...
                        <tr>
                            ...
                            <td>SAR17,756.000</td>
                            <td>2022-09-14</td>
                            <td><span className='btn-orange-table btn-table'>DISPATCH</span></td>
                        </tr>
                    </tbody>
                    </table>
                    </div>
